...
namespace Diccionario_de_datos
{
    public partial class Form1 : Form
    {
        ...
        int pesoSecondB = 0;
        int pesoSinB = 0;
        bool primaryRepetidaxd = false;

        int contSecundaryFD = 0;
        int acumSecundaryFD = 2080;
        bool priSecundaryFD = false;

        public class InfoFD
        {
            public int dirR { get; set; }
            public int dirS { get; set; }
            public int clave { get; set; }
        }

        List<InfoFD> infoList = new List<InfoFD>();


        //String NombreAtriPrimary;
        ...
        public Form1()
        {
            ...
            cmbReg.Items.Insert(0, "Secuencial");
            cmbReg.Items.Insert(1, "Indexado");
            cmbReg.Items.Insert(2, "Arbol B+");
            comboBoxBus.Items.Add("0");
            comboBoxBus.Items.Add("1");
            comboBoxBus.Items.Add("2");
            comboBoxBus.Items.Add("3");
        ...
        private void actualizaDataGridForeanKey()
        {
            ...
            if (priSecundaryFD == false)
            {
                for (int z = 0; z < aux.hsRegistros.Count; z++)
                {
                    InfoFD inFD = new InfoFD();
                    inFD.dirR = 0;
                    inFD.dirS = 0;
                    inFD.clave = 0;
                    infoList.Add(inFD);
            ...
            for (int k = 0; k < aux.listsForeanKey.Count; k++)
                if (aux.listsForeanKey[k].Count != 0)
                {
                    for (int i = 0; i < aux.listsForeanKey[k].Count; i++)
                    {
                        ...
                        for (int j = 0; j < aux.listsForeanKey[k][i].listDirecciónes.Count + 2; j++)
                        {
                            if (aux.listsForeanKey[k][i].iClave != -1)
                                ...
                                {
                                    dgForeanKey.Rows[dgForeanKey.Rows.Count - 2].Cells[j].Value = aux.listsForeanKey[k][i].dClave;
                                }
                                else
                                {
                                    dgForeanKey.Rows[dgForeanKey.Rows.Count - 2].Cells[j].Value = aux.listsForeanKey[k][i].listDirecciónes[j - 2];
                                }
                            ...
                            /*if (j == 0 )
                            {
                                dgForeanKey.DefaultCellStyle.BackColor = System.Drawing.Color.Gray;
                            }*/
                        }
                    }
                }
        ...
        private void actualizaDataGridAtributos()
        {
            ...
            if (Entaux.hsAtributos.Count != 0)
            {
                for (int i = 0; i < Entaux.alNomAtributos.Count; i++)
                {
                    ...
                    if (cmbReg.SelectedIndex == 1 && aux.iTipoIndice == 1)
                    {
                        dgAtributos.Rows.Add(aux.nombre, aux.cTipo, aux.iLongitud, aux.iTipoIndice, aux.lDirAtributo, dirB, aux.lDirSigAtrib);
                    }else if (cmbReg.SelectedIndex == 1 && aux.iTipoIndice == 3)
                    {
                        dgAtributos.Rows.Add(aux.nombre, aux.cTipo, aux.iLongitud, aux.iTipoIndice, aux.lDirAtributo, dirS, aux.lDirSigAtrib);
                    }
                    else
                    {
                    ...
                    if (aux.iTipoIndice == 2)
                    {
                        rowPrimary = i+1;
                        pesoPrimB = aux.iLongitud;
                        //NombreAtriPrimary = aux.nombre;
                    }else if (aux.iTipoIndice == 3)
                    {
                        rowSecondB = i + 1;
                        pesoSecondB = aux.iLongitud;
                    }
                    else if(aux.iTipoIndice == 1)
                    {
                        rowBusqB = i + 1;
                        pesoBusqB = aux.iLongitud;
                    }
                    else if (aux.iTipoIndice == 0)
                    {
                        rowSinB = i + 1;
                        pesoSinB = aux.iLongitud;
                    }
                }
            }
        }
        ...
        private void guardaAtributo()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Entaux.hsAtributos.Count; i++)
                {
                    if(Entaux.alNomAtributos[i].ToString() == sNombreAtr)
                    {
                        MessageBox.Show("Error Atributo Existe");
                        existeAtri = true;
                    }
                }
                if (existeAtri == false)
        ...
        private void btnModifica_Click(object sender, EventArgs e)
        {
            ...
            if (bndModfica && validarCampos())
            {
                ...
                if (nomAtriAnt != s)
                {
                    for (int i = 0; i < Entaux.hsAtributos.Count; i++)
                {
                    if (Entaux.alNomAtributos[i].ToString() == s)
                    {
                        MessageBox.Show("Error Atributo Existe");
                        existeAtri = true;
                    }
        ...
        private void EliminaEnt_Click(object sender, EventArgs e)
        {
            ...
            if (bndElimina)
            {
                ...
                {
                    MessageBox.Show("NO se puede Eliminar la Entidad");
                }
        ...
        private void NewAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!validaDgRegistros())
                {
                    ...
                    else if (primaryRepetidaxd == true)
                    {
                        primaryRepetidaxd = false;
                    }
                    actualizaDataGridEntidades();
                    actualizaDataGridAtributos();
                    EscribeRegistros();
        ...
        private void Modifica_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Entidad auxFD = ((Entidad)(hsEntidades[sNomEntidad]));


                string sPrimaryKeyFD = "", valFD, sNomAtFD;
                int renglonFD = auxFD.alCveBusqueda.Count;
                renglonFD = renglonSeleccionado;
                string nomRegFD = (auxFD.alCveBusqueda[renglonFD]).ToString();
                int posFD = auxFD.alCveBusqueda.IndexOf(nomRegFD);
                int tamCadFD;

                long direcFD = Convert.ToInt64(((ArrayList)auxFD.hsRegistros[nomRegFD])[0]);
                int psFD = auxFD.listPrimaryKey.FindIndex(x => x.lDirección == direcFD);
                int valorReservaFD = auxFD.listPrimaryKey[psFD].iClave;
                auxFD.listPrimaryKey.RemoveAt(psFD);
                long lDirRegistroFD = nvll;
                char tipoFD = '\0';

                identificaTipoIndice(2, ref sPrimaryKeyFD);
                for (int i = 0; i < dgRegistros.Columns.Count; i++)
                {
                    sNomAtFD = dgRegistros.Columns[i].Name.ToString();

                    valFD = (dgRegistros.Rows[renglonFD].Cells[i].Value.ToString());

                    if (i == 0)
                    {
                        lDirRegistroFD = Convert.ToInt64(valFD);
                    }

                    if (!dgRegistros.Columns[i].ReadOnly)
                    {
                        tipoFD = ((Atributo)(aux.hsAtributos[sNomAtFD])).cTipo;//
                        if (tipoFD == 'C')
                        {
                            tamCadFD = ((Atributo)(aux.hsAtributos[sNomAtFD])).iLongitud;
                            valFD = ajustaTam(valFD, tamCadFD);
                        }
                    }

                    if (sPrimaryKeyFD == sNomAtFD)
                    {
                        PrimaryKey pKFD = new PrimaryKey(Convert.ToInt32(valFD), lDirRegistroFD);
                        for (int ip = 0; ip < auxFD.listPrimaryKey.Count; ip++)
                        {
                            if (auxFD.listPrimaryKey[ip].iClave == pKFD.iClave)
                            {
                                
                                MessageBox.Show("Ya existe esta Llave Primaria");
                                primaryRepetidaxd = true;


                            }
                        }

                        pKFD.iClave = valorReservaFD;
                        auxFD.listPrimaryKey.Add(pKFD);
        ...
        private void guardaRegistroMemoria()//modificar los indices
        {
            ...
            bool primariaExiste = false;
            int valorReserva = 0;
            bool bandValPrim = false;
            string valorPKI = "";
            ...
            if(bandModifReg)
            {
                ...
                valorReserva = aux.listPrimaryKey[ps].iClave;
            ...
            if (cmbReg.SelectedIndex == 1)
            {
                identificaTipoIndice(2, ref sAtrCveBus);
            }
            else if(cmbReg.SelectedIndex == 0)
            {
                identificaTipoIndice(1, ref sAtrCveBus);
            }
            else if(cmbReg.SelectedIndex == 2)
            {
                identificaTipoIndice(4, ref sAtrCveBus);
            }
            //identificaTipoIndice(1, ref sAtrCveBus);
            ...
            {
                if (primariaExiste == false || bandModifReg == true)
                {
                            ...
                            if (lsForeanKey[k] == sNomAt)
                            {
                                ...
                                if (!bnde)
                                {
                                    if (tipo == 'E')
                                    {
                                        ...
                                        acumSecundaryFD += 1048;
                                        contSecundaryFD++;
                                        fK.dClave = acumSecundaryFD;
                    ...
                    if (sPrimaryKey == sNomAt)
                    {
                        ...
                        for (int ip = 0; ip < aux.listPrimaryKey.Count; ip++)
                        {
                            if (aux.listPrimaryKey[ip].iClave == pK.iClave)
                            {
                                primariaExiste = true;
                                MessageBox.Show("Ya existe esta Llave Primaria");
                                primaryRepetidaxd = true;
                        ...
                        if (primariaExiste == false)
                        {
                            aux.listPrimaryKey.Add(pK);
                            valorPKI = pK.iClave.ToString();
                        }
                        else if(bandModifReg == true)
                        {
                            pK.iClave = valorReserva;
                            valorPKI = pK.iClave.ToString();
                            aux.listPrimaryKey.Add(pK);
                            bandValPrim = true;
                        }
                    ...
                    if (sAtrCveBus != "" && primariaExiste == false)
                    {
                    ...
                    if (i == dgRegistros.Columns.Count - 1)
                    {
                        ...
                        {
                            //MessageBox.Show("Listo");
                            //insertaRegistroEnorden(ref aux, ref valorPKI, ref val, ref alRegistroActual);
                            insertaRegistroEnorden(ref aux, ref sCveB, ref val, ref alRegistroActual);
                        }
                        if (cmbReg.SelectedIndex == 2)
                        {
                            //MessageBox.Show("Listo");
                            insertaRegistroEnorden(ref aux, ref sCveB, ref val, ref alRegistroActual);
                        }
                    ...
                    if(bandValPrim == true && primariaExiste == false)
                    {
                        alRegistroActual.Add(valorReserva);
                        bandValPrim = false;
                    }
                    else if (primariaExiste == false)
                    {
        ...
        private void insertaRegistroEnorden(ref Entidad aux,ref string sCveB, ref string val, ref ArrayList alRegistroActual)
        {
            if (aux.hsRegistros.Count != 0)
            {
                ...
                if (cmbReg.SelectedIndex == 0)
                {
                    pos = aux.alCveBusqueda.IndexOf(sCveB);
                }
                if (cmbReg.SelectedIndex == 1)
                {
                    /*int xIndexado = Int32.Parse(sCveB);
                    for (int ip = 0; ip < aux.listPrimaryKey.Count; ip++)
                    {
                        if (aux.listPrimaryKey[ip].iClave == xIndexado)
                        {
                            pos = ip;
                        }
                    }*/
                ...
                if (pos > 0)
                {
                    ...
                    {
                        //int xIndexado = Int32.Parse(sCveB);
                        //string nomAntCveBus = (aux.listPrimaryKey[pos -1].iClave).ToString();
                        
                        //val = ((ArrayList)aux.listPrimaryKey[pos - 1].iClave.ToString())[dgRegistros.Columns.Count - 1].ToString();
                        //((ArrayList)aux.listPrimaryKey[pos - 1].[nomAntCveBus])[dgRegistros.Columns.Count - 1] = alRegistroActual[0];
                        string nomAntCveBus = (aux.alCveBusqueda[pos - 1]).ToString();
                        val = ((ArrayList)aux.hsRegistros[nomAntCveBus])[dgRegistros.Columns.Count - 1].ToString();
                        ((ArrayList)aux.hsRegistros[nomAntCveBus])[dgRegistros.Columns.Count - 1] = alRegistroActual[0];
                ...
                else
                {
                    ...
                    if (cmbReg.SelectedIndex == 1)
                    {
                        ...
                        val = ((ArrayList)aux.hsRegistros[nomSegCveBus])[0].ToString();
                        /*int xIndexado = Int32.Parse(sCveB);
                        int nomSegCveBus = (aux.listPrimaryKey[pos + 1].iClave);
                        ///Aqui se modifica la dir sig
                        val = ((ArrayList)aux.hsRegistros[nomSegCveBus])[0].ToString();*/
        ...
        private void actualizaDataGridRegistros()
        {
            ...
            /*if (cmbReg.SelectedIndex == 1)
            {
                ...
                //dgRegistros.Columns[rowPrimary].SortMode = DataGridViewColumnSortMode.Programmatic;
                dgRegistros.Sort(dgRegistros.Columns[rowPrimary], ListSortDirection.Ascending);
        ...
        private void buttonBusqueda_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxBus.SelectedIndex == 0)
            {
                ...
                if (auxEnt.hsRegistros.Count != 0)
                {
                    ...
                    for (int i = 0; i < auxEnt.alCveBusqueda.Count; i++)
                    {
                        sNom = (auxEnt.alCveBusqueda[i]).ToString();
                        aux = (ArrayList)(auxEnt.hsRegistros[sNom]);
                        string sNombreAtrb = textBoxBusqueda.Text;

                        nombandBus = aux[rowSinB].ToString();
                        string sNomAtr30b = ajustaTam(sNombreAtrb, pesoSinB);
                        if (pesoSinB == 4)
                        {
                            sNomAtr30b = sNombreAtrb;
                        }
                        if (sNomAtr30b == nombandBus)
                        {

                            dataGridViewBusq.Rows.Add();
                            for (int j = 0; j < dataGridViewBusq.ColumnCount; j++)
                            {
                                dataGridViewBusq.Rows[contBAux].Cells[j].Value = aux[j];
            ...
            else if (comboBoxBus.SelectedIndex == 1)
            {
                Entidad auxEnt = ((Entidad)(hsEntidades[sNomEntidad]));
                int contBAux = 0;
                ...
                if (auxEnt.hsRegistros.Count != 0)
                {
                    ...
                    for (int i = 0; i < auxEnt.alCveBusqueda.Count; i++)
                    {
                        ...
                        nombandBus = aux[rowBusqB].ToString();
                        string sNomAtr30b = ajustaTam(sNombreAtrb, pesoBusqB);
                        if (pesoBusqB == 4)
                        {
                            sNomAtr30b = sNombreAtrb;
                        }
            ...
            else if (comboBoxBus.SelectedIndex == 2)
            {
                Entidad auxEnt = ((Entidad)(hsEntidades[sNomEntidad]));
                int contBAux = 0;
                ...
                if (auxEnt.hsRegistros.Count != 0)
                {
                    ...
                    for (int i = 0; i < auxEnt.alCveBusqueda.Count; i++)
                    {
                        ...
                        nombandBus = aux[rowPrimary].ToString();
                        string sNomAtr30b = ajustaTam(sNombreAtrb, pesoPrimB);
                        if (pesoPrimB == 4)
                        {
                            sNomAtr30b = sNombreAtrb;
                        }
            ...
            else if (comboBoxBus.SelectedIndex == 3)
            {
                Entidad auxEnt = ((Entidad)(hsEntidades[sNomEntidad]));
                int contBAux = 0;
                ...
                if (auxEnt.hsRegistros.Count != 0)
                {
                    ...
                    for (int i = 0; i < auxEnt.alCveBusqueda.Count; i++)
                    {
                        ...
                        nombandBus = aux[rowSecondB].ToString();
                        
                        string sNomAtr30b = ajustaTam(sNombreAtrb, pesoSecondB);
                        if(pesoSecondB == 4)
                        {
                            sNomAtr30b = sNombreAtrb;
                        }
        ...
        private void GeneraColumnasBusqueda()
        {
            int iNumAtr = ((Entidad)(hsEntidades[sNomEntidad])).hsAtributos.Count;
            string inom;

            dataGridViewBusq.Columns.Add("DRegistro", "DRegistro");
            ...
            for (int i = 0; i < iNumAtr; i++)
            {
                ...
                if (auxAt.iTipoIndice == 5)
                {
                    ...
                    col.HeaderText = inom + "=>>";
                    col.ReadOnly = true;
                    col.CellTemplate = dataGridViewBusq.Columns[0].CellTemplate;
                    dataGridViewBusq.Columns.Add(inom, inom);
                    dataGridViewBusq.Columns.Add(col);
                }
                else
                {
                    dataGridViewBusq.Columns.Add(inom, inom);
            ...
            dataGridViewBusq.Columns.Add("DSigRegistro", "DSigRegistro");

            dataGridViewBusq.Columns[0].ReadOnly = true;
            dataGridViewBusq.Columns[dgRegistros.Columns.Count - 1].ReadOnly = true;

            
        }

        private void CierrayAbreIndexado()
        {
